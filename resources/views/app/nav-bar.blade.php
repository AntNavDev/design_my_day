<div class="row">
    <div class="col-md-offset-4 col-md-4 title">
        ...
        @endif
            <span class="title_info"><span id="month_name">{{ $viewed_month->getMonthAsText() }}</span>, {{ $viewed_month->getYear() }}</span>
        @if( ( Request::is( 'calendar/*' ) || Request::is( 'calendar' ) ) && ! ( Request::is( 'calendar/displayWeek/*' ) ) )
    ...
    <div class="col-md-4">
        <div class="row view_type_container">
            <a href="{{ route( 'changeMonth', [ $increment, $viewed_month->getYear() ] ) }}" class="view_type"><div class="col-md-4">Month</div></a>
            <a href="{{ route( 'displayWeek', [ $viewed_month->getFirstDay(), $increment, $viewed_month->getYear() ] ) }}" class="view_type"><div class="col-md-4">Week</div></a>
